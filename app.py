...
def ios_number_input(label: str, key: str, value: str = "", allow_decimal: bool = True, placeholder: str = "") -> str:
    """
    A Streamlit text_input that forces iPhone's numeric keypad by setting inputmode on THIS field.
    Returns a cleaned string; keep label UNIQUE so aria-label matching is unambiguous.
    """
